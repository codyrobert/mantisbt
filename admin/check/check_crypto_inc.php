...
check_print_test_row(
	...
	strlen( \Flickerbox\Config::get_global( 'crypto_master_salt' ) ) >= 16,
...
check_print_test_row(
	...
	\Flickerbox\Config::get_global( 'login_method' ) != CRYPT_FULL_SALT,
	array( false => 'Login method CRYPT_FULL_SALT has been deprecated and should not be used.' )
);

if( \Flickerbox\Config::get_global( 'login_method' ) != LDAP ) {
	check_print_test_warn_row(
		'login_method is set to MD5',
		\Flickerbox\Config::get_global( 'login_method' ) == MD5,
