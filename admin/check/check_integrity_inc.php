...
$t_absolute_base_dir = realpath( \Core\Config::get_global( 'absolute_path' ) ) . DIRECTORY_SEPARATOR;
...
$t_base_dir = realpath( \Core\Config::get_global( 'core_path' ) ) . DIRECTORY_SEPARATOR;
$t_ignore_files = array(
	'core/classes/'
);
check_file_integrity_recursive( $t_base_dir, $t_base_dir, 'core/', $t_ignore_files );

$t_base_dir = realpath( \Core\Config::get_global( 'class_path' ) ) . DIRECTORY_SEPARATOR;
check_file_integrity_recursive( $t_base_dir, $t_base_dir, 'core/classes/' );

$t_base_dir = realpath( \Core\Config::get_global( 'library_path' ) ) . DIRECTORY_SEPARATOR;
$t_ignore_files = array(
	'library/jpgraph/',
	'library/FirePHPCore/'
);
...
$t_base_dir = realpath( \Core\Config::get_global( 'language_path' ) ) . DIRECTORY_SEPARATOR;
