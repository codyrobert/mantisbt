...
check_print_test_row(
	...
	array(
		true => 'The anonymous user account currently has an access level of: ' . htmlentities( \Flickerbox\Helper::get_enum_element( 'access_levels', user_get_access_level( $t_anonymous_user_id ) ) ),
