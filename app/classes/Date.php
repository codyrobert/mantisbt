...
class Date
{
	 ...
	 * @access public
	 */
	static function set_timezone( $p_timezone ) {
	 ...
	 * @access public
	 */
	static function restore_timezone() {
		global $g_cache_timezone;
	 ...
	 * @access public
	 */
	static function print_month_option_list( $p_month = 0 ) {
		for( $i = 1;$i <= 12;$i++ ) {
	 ...
	 * @access public
	 */
	static function print_numeric_month_option_list( $p_month = 0 ) {
		for( $i = 1;$i <= 12;$i++ ) {
			if( $i == $p_month ) {
	 ...
	 * @access public
	 */
	static function print_day_option_list( $p_day = 0 ) {
		for( $i = 1;$i <= 31;$i++ ) {
			if( $i == $p_day ) {
				echo '<option value="' . $i . '" selected="selected">' . $i . '</option>';
			} else {
	 ...
	 * @access public
	 */
	static function print_year_option_list( $p_year = 0 ) {
	 ...
	 * @access public
	 */
	static function print_date_selection_set( $p_name, $p_format, $p_date = 0, $p_default_disable = false, $p_allow_blank = false, $p_year_start = 0, $p_year_end = 0 ) {
