...
class Graph
{
	 ...
	 * @return Graph
	 */
	static function generate_rel_graph( $p_bug_id ) {
	 ...
	 * @return Digraph
	 */
	static function generate_dep_graph( $p_bug_id, $p_horizontal = false ) {
		# List of visited issues and their data.
		$v_bug_list = array();
	 ...
	 * @return boolean
	 */
	static function add_parent( array &$p_bug_list, $p_bug_id ) {
	 ...
	 * @return boolean
	 */
	static function add_child( array &$p_bug_list, $p_bug_id ) {
	 ...
	 * @return void
	 */
	static function output_image( Graph $p_graph ) {
	 ...
	 * @return void
	 */
	static function output_map( Graph $p_graph, $p_name ) {
