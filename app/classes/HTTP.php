...
class HTTP
{
	 ...
	 */
	static function is_protocol_https() {
	 ...
	 */
	static function is_browser_internet_explorer() {
	 ...
	 */
	static function is_browser_chrome() {
		$t_user_agent = isset( $_SERVER['HTTP_USER_AGENT'] ) ? $_SERVER['HTTP_USER_AGENT'] : 'none';
	 ...
	 * @return void
	 */
	static function content_disposition_header( $p_filename, $p_inline = false ) {
		if( !headers_sent() ) {
	 ...
	 * @return void
	 */
	static function content_headers() {
		if( !headers_sent() ) {
	 ...
	 * @return void
	 */
	static function security_headers() {
		if( !headers_sent() ) {
			...
			header( 'Content-Security-Policy: default-src \'self\' \'unsafe-inline\'; img-src \'self\' http://secure.gravatar.com/; script-src \'self\' \'unsafe-inline\' \'unsafe-eval\' http://ajax.googleapis.com/; frame-ancestors \'none\'' );
			if( \Core\HTTP::is_protocol_https() ) {
