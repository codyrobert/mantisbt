...
class GPC
{
	 ...
	 * @return null
	 */
	static function get( $p_var_name, $p_default = null ) {
	 ...
	 * @return boolean
	 */
	static function is_set( $p_var_name ) {
		if( isset( $_POST[$p_var_name] ) ) {
			return true;
		} else if( isset( $_GET[$p_var_name] ) ) {
			return true;
	 ...
	 * @return string|null
	 */
	static function get_string( $p_var_name, $p_default = null ) {
	 ...
	 * @return integer|null
	 */
	static function get_int( $p_var_name, $p_default = null ) {
		# Don't pass along a default unless one was given to us
		#  otherwise we prevent an error being triggered
		$t_args = func_get_args();
		$t_result = call_user_func_array( '\\Core\\GPC::get', $t_args );
	 ...
	 * @return boolean
	 */
	static function isset_custom_field( $p_var_name, $p_custom_field_type ) {
	 ...
	 * @return string
	 */
	static function get_custom_field( $p_var_name, $p_custom_field_type, $p_default = null ) {
		switch( $p_custom_field_type ) {
	 ...
	 * @return array
	 */
	static function get_string_array( $p_var_name, array $p_default = null ) {
		# Don't pass along a default unless one was given to us
		# otherwise we prevent an error being triggered
		$t_args = func_get_args();
		$t_result = call_user_func_array( '\\Core\\GPC::get', $t_args );
	 ...
	 * @return array
	 */
	static function get_int_array( $p_var_name, array $p_default = null ) {
		# Don't pass along a default unless one was given to us
		# otherwise we prevent an error being triggered
		$t_args = func_get_args();
		$t_result = call_user_func_array( '\\Core\\GPC::get', $t_args );
	 ...
	 * @return array
	 */
	static function get_bool_array( $p_var_name, array $p_default = null ) {
		# Don't pass along a default unless one was given to us
		# otherwise we prevent an error being triggered
		$t_args = func_get_args();
	 ...
	 * @return string
	 */
	static function get_cookie( $p_var_name, $p_default = null ) {
	 ...
	 */
	static function set_cookie( $p_name, $p_value, $p_expire = false, $p_path = null, $p_domain = null, $p_httponly = true ) {
	 ...
	 * @return mixed
	 */
	static function get_file( $p_var_name, $p_default = null ) {
	 ...
	 * @return void
	 */
	static function make_array( $p_var_name ) {
	 ...
	 * @return boolean
	 */
	static function string_to_bool( $p_string ) {
