...
class Event
{
	 ...
	 * @return void
	 */
	static function event_declare( $p_name, $p_type = EVENT_TYPE_DEFAULT ) {
	 ...
	 * @return null
	 */
	static function hook( $p_name, $p_callback, $p_plugin = 0 ) {
		global $g_event_cache;
	 ...
	 * @return void
	 */
	static function clear_callbacks() {
		global $g_event_cache;
	 ...
	 * @access public
	 */
	static function signal( $p_name, $p_params = null, $p_params_dynamic = null, $p_type = null ) {
		global $g_event_cache;
	 ...
	 * @access public
	 */
	static function callback( $p_event, $p_callback, $p_plugin, $p_params = null ) {
		$t_value = null;
	 ...
	 * @return void
	 */
	static function type_output( $p_event, array $p_callbacks, $p_params = null ) {
		$t_prefix = '';
		$t_separator = '';
		$t_postfix = '';
	 ...
	 * @access public
	 */
	static function type_chain( $p_event, array $p_callbacks, $p_input, $p_params = null ) {
		$t_output = $p_input;
	 ...
	 * @access public
	 */
	static function type_first( $p_event, array $p_callbacks, $p_params ) {
		$t_output = null;
	 ...
	 * @access public
	 */
	static function type_default( $p_event, array $p_callbacks, $p_data ) {
		$t_output = array();
		foreach( $p_callbacks as $t_plugin => $t_callbacks ) {
			foreach( $t_callbacks as $t_callback ) {
