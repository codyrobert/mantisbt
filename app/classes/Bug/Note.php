...
class Note
{
	 ...
	 * @access public
	 */
	static function get_field( $p_bugnote_id, $p_field_name ) {
		static $s_vars;
	 ...
	 * @access public
	 */
	static function get_all_bugnotes( $p_bug_id ) {
	 ...
	 * @access public
	 */
	static function stats_get_events_array( $p_bug_id, $p_from, $p_to ) {
	 ...
	 * @access public
	 */
	static function stats_get_project_array( $p_project_id, $p_from, $p_to, $p_cost ) {
		$t_params = array();
		$c_to = strtotime( $p_to ) + SECONDS_PER_DAY - 1;
		$c_from = strtotime( $p_from );
	 ...
	 * @access public
	 */
	static function clear_cache( $p_bugnote_id = null ) {
