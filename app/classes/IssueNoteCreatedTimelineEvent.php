...
class IssueNoteCreatedTimelineEvent extends TimelineEvent {
	...
	public function html() {
		...
		$t_html .= '<div class="action">' . sprintf( \Core\Lang::get( 'timeline_issue_note_created' ), \Core\User::get_name( $this->user_id ), \Core\String::get_bug_view_link( $this->issue_id ) ) . '</div>';
