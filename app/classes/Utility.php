...
class Utility
{
	 ...
	 * @access public
	 */
	static function trans_bool( $p_num ) {
		if( 0 == $p_num ) {
			return '&#160;';
		} else {
			return 'X';
	 ...
	 * @access public
	 */
	static function terminate_directory_path( $p_path ) {
	 ...
	 * @access public
	 */
	static function is_blank( $p_var ) {
		$p_var = trim( $p_var );
	 ...
	 * @access public
	 */
	static function ini_get_bool( $p_name ) {
	 ...
	 * @access public
	 */
	static function ini_get_number( $p_name ) {
	 ...
	 * @access public
	 */
	static function multi_sort( array $p_array, $p_key, $p_direction = ASCENDING ) {
	 ...
	 * @access public
	 */
	static function get_gd_version() {
	 ...
	 * @access public
	 */
	static function is_page_name( $p_string ) {
	 ...
	 * @access public
	 */
	static function is_windows_server() {
	 ...
	 * @access public
	 */
	static function getClassProperties( $p_classname, $p_type = 'public', $p_return_object = false, $p_include_parent = false ) {
