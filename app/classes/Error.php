...
class Error
{
	 ...
	 */
	static function handler( $p_type, $p_error, $p_file, $p_line, array $p_context ) {
	 ...
	 * @return void
	 */
	static function print_details( $p_file, $p_line, array $p_context ) {
		?>
			<table class="width90">
				<tr>
	 ...
	 * @return void
	 */
	static function print_context( array $p_context ) {
	 ...
	 * @return string
	 */
	static function build_parameter_string( $p_param, $p_showtype = true, $p_depth = 0 ) {
		if( $p_depth++ > 10 ) {
	 ...
	 * @access public
	 */
	static function string( $p_error ) {
	 ...
	 * @return void
	 */
	static function proceed_url( $p_url ) {
	 ...
	 */
	static function alternate_class() {
		static $s_errindex = 1;
