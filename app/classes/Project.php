...
class Project
{
	 ...
	 */
	static function cache_row( $p_project_id, $p_trigger_errors = true ) {
	 ...
	 * @return void
	 */
	static function clear_cache( $p_project_id = null ) {
	 ...
	 * @return void
	 */
	static function update( $p_project_id, $p_name, $p_description, $p_status, $p_view_state, $p_file_path, $p_enabled, $p_inherit_global ) {
	 ...
	 * @return void
	 */
	static function copy_custom_fields( $p_destination_id, $p_source_id ) {
	 ...
	 * @return integer
	 */
	static function get_local_user_access_level( $p_project_id, $p_user_id ) {
		$p_project_id = (int)$p_project_id;
	 ...
	 * @return array
	 */
	static function get_all_user_rows( $p_project_id = ALL_PROJECTS, $p_access_level = ANYBODY, $p_include_global_users = true ) {
	 ...
	 * @return void
	 */
	static function add_user( $p_project_id, $p_user_id, $p_access_level ) {
