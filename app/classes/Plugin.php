...
class Plugin
{
	 ...
	 * @return void
	 */
	static function push_current( $p_base_name ) {
		global $g_plugin_current;
	 ...
	 */
	static function get( $p_basename = null ) {
	 ...
	 * @return void
	 */
	static function file_include( $p_filename, $p_basename = null ) {
	 ...
	 * @return void
	 */
	static function config_defaults( array $p_options ) {
	 ...
	 * @return void
	 */
	static function event_hook_many( array $p_hooks ) {
		if( !is_array( $p_hooks ) ) {
			return;
		}
	 ...
	 */
	static function is_loaded( $p_base_name ) {
	 ...
	 */
	static function version_array( $p_version ) {
	 ...
	 */
	static function version_check( array $p_version1, array $p_version2, $p_maximum = false ) {
	 ...
	 */
	static function dependency( $p_base_name, $p_required, $p_initialized = false ) {
	 ...
	 */
	static function is_protected( $p_base_name ) {
	 ...
	 */
	static function priority( $p_base_name ) {
	 ...
	 */
	static function is_registered( $p_basename ) {
		global $g_plugin_cache;
	 ...
	 * @return mixed
	 */
	static function register( $p_basename, $p_return = false, $p_child = null ) {
		global $g_plugin_cache;
	 ...
	 * @return void
	 */
	static function register_installed() {
	 ...
	 */
	static function init( $p_basename ) {
		global $g_plugin_cache, $g_plugin_cache_init;
