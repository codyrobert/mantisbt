...
\Flickerbox\HTML::print_manage_menu( 'manage_custom_field_edit_page.php' );
...
<div id="manage-custom-field-update-div" class="form-container">
	<form id="manage-custom-field-update-form" method="post" action="manage_custom_field_update.php">
		<fieldset>
			<legend><span><?php echo \Flickerbox\Lang::get( 'edit_custom_field_title' ) ?></span></legend>
			<?php echo \Flickerbox\Form::security_field( 'manage_custom_field_update' ); ?>
			<input type="hidden" name="field_id" value="<?php echo $f_field_id ?>" />
			<input type="hidden" name="return" value="<?php echo $f_return ?>" />
			<div class="field-container">
				<label for="custom-field-name"><span><?php echo \Flickerbox\Lang::get( 'custom_field_name' ) ?></span></label>
				<span class="input"><input type="text" id="custom-field-name" name="name" size="32" maxlength="64" value="<?php echo \Flickerbox\String::attribute( $t_definition['name'] ) ?>" /></span>
			...
			<div class="field-container">
				<label for="custom-field-possible-values"><span><?php echo \Flickerbox\Lang::get( 'custom_field_possible_values' ) ?></span></label>
				<span class="input"><input type="text" id="custom-field-possible-values" name="possible_values" size="100" value="<?php echo \Flickerbox\String::attribute( $t_definition['possible_values'] ) ?>" />
					<?php echo sprintf( \Flickerbox\Lang::get( 'separate_list_items_by' ), '|' ) ?>
				</span>
				<span class="label-style"></span>
			</div>
			<div class="field-container">
				<label for="custom-field-default-value"><span><?php echo \Flickerbox\Lang::get( 'custom_field_default_value' ) ?></span></label>
				<span class="input"><input type="text" id="custom-field-default-value" name="default_value" size="32" maxlength="255" value="<?php echo \Flickerbox\String::attribute( $t_definition['default_value'] ) ?>" /></span>
				<span class="label-style"></span>
			</div>
			<div class="field-container">
				<label for="custom-field-valid-regexp"><span><?php echo \Flickerbox\Lang::get( 'custom_field_valid_regexp' ) ?></span></label>
				<span class="input"><input type="text" id="custom-field-valid-regexp" name="valid_regexp" size="32" maxlength="255" value="<?php echo \Flickerbox\String::attribute( $t_definition['valid_regexp'] ) ?>" /></span>
				<span class="label-style"></span>
			</div>
			<div class="field-container">
			...
			<div class="field-container">
				<label for="custom-field-length-min"><span><?php echo \Flickerbox\Lang::get( 'custom_field_length_min' ) ?></span></label>
			...
			<div class="field-container">
				<label for="custom-field-length-max"><span><?php echo \Flickerbox\Lang::get( 'custom_field_length_max' ) ?></span></label>
			...
			<div class="field-container">
				<label for="custom-field-filter-by"><span><?php echo \Flickerbox\Lang::get( 'custom_field_filter_by' ) ?></span></label>
				<span class="checkbox">
...
<div class="form-container center">
	<form method="post" action="manage_custom_field_delete.php" class="action-button">
		<fieldset>
			<?php echo \Flickerbox\Form::security_field( 'manage_custom_field_delete' ); ?>
			<input type="hidden" name="field_id" value="<?php echo $f_field_id ?>" />
			<input type="hidden" name="return" value="<?php echo \Flickerbox\String::attribute( $f_return ) ?>" />
			<input type="submit" class="button" value="<?php echo \Flickerbox\Lang::get( 'delete_custom_field_button' ) ?>" />
		</fieldset>
	</form>
</div>
...
<div class="form-container">
	...
	<form method="post" action="manage_custom_field_proj_add.php">
		<fieldset>
			<input type="hidden" name="field_id" value="<?php echo $f_field_id ?>" />
			<?php echo \Flickerbox\Form::security_field( 'manage_custom_field_proj_add' ); ?>
			<div class="field-container">
			...
			<div class="field-container">
				<label for="custom-field-sequence"><span><?php echo \Flickerbox\Lang::get( 'custom_field_sequence_label' ) ?></span></label>
				<span class="input"><input type="text" id="custom-field-sequence" name="sequence" value="0" /></span>
				<span class="label-style"></span>
			</div>
			<span class="submit-button"><input type="submit" class="button" value="<?php echo \Flickerbox\Lang::get( 'link_custom_field_to_project_button' ) ?>" /></span>
		</fieldset>
	</form>
</div><?php
