...
if( \Flickerbox\Current_User::get_pref( 'refresh_delay' ) > 0 ) {
	\Flickerbox\HTML::meta_redirect( 'my_view_page.php?refresh=true', \Flickerbox\Current_User::get_pref( 'refresh_delay' ) * 60 );
}
