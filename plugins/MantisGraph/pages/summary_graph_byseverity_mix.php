...
if( $t_token == null ) {
	$t_metrics = enum_bug_group( \Flickerbox\Lang::get( 'severity_enum_string' ), 'severity' );
} else {
	$t_metrics = json_decode( $t_token, true );
}

graph_group( $t_metrics, \Flickerbox\Plugin::langget( 'by_severity_mix' ), $f_width, $f_width * $t_ar );
