...
$t_metrics = enum_bug_group( \Core\Lang::get( 'severity_enum_string' ), 'severity' );
...
<tr>
	<td class="form-title">
		<?php echo \Core\Plugin::langget( 'graph_imp_severity_title' ) ?>
	</td>
</tr>
<tr>
	<td class="center">
		<img src="<?php echo \Core\Plugin::page( 'summary_graph_byseverity.php' )?>&amp;width=<?php echo $t_graph_width?>" alt="" />
	</td>
</tr>
<tr>
	<td class="center">
		<img src="<?php echo \Core\Plugin::page( 'summary_graph_byseverity_pct.php' )?>&amp;width=<?php echo $t_graph_width?>" alt="" />
	</td>
</tr>
<tr>
	<td class="center">
		<img src="<?php echo \Core\Plugin::page( 'summary_graph_byseverity_mix.php' )?>&amp;width=<?php echo $t_graph_width?>" alt="" />
	</td>
</tr>
</table>
